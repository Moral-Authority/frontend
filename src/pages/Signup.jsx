...
const Signup = () => {
  return (
    <div className="min-h-screen w-full create-accouent-div flex flex-col-reverse lg:flex-row bg-white">
      ...
      <section className="w-full flex items-center justify-center lg:items-start lg:w-1/2 lg:peer-first:h-full bg-[#FBF7EC]">
        <img src={Account} className="h-full  sm:h-96 lg:h-fit px-0" alt="" />
      </section>
    </div>
  );
};
