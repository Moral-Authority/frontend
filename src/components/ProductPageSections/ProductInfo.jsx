...
const ProductInfo = () => {
  ...
  return (
    <div className="w-1/2 flex flex-col px-10 items-start">
      {/* Upper Section */}
      <section className="flex flex-col pb-3 border-b">
        ...
        <div className="flex justify-between mt-3 items-center">
          <p className="text-[#5F646F] text-xl font-semibold leading-5">$350</p>
      ...
      <section className="flex flex-col py-4 space-y-5">
        <div className="flex space-x-5 items-center">
          <label className="text-[#697383] text-sm">Quantity:</label>
          <div className="py-1 px-2 border w-20 flex justify-between items-center">
            <button
